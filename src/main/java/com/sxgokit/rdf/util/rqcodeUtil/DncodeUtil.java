...
public class DncodeUtil {
	...
	public static void main(String[] args) {
		...
		DncodeUtil.encode(contents, width, height, imgPath);
		System.out.println("finished zxing EAN-13 encode.");

		String decodeContent = DncodeUtil.decode(imgPath);
		...
		DncodeUtil.encode2(contents2, width2, height2, imgPath2);
		System.out.println("finished zxing encode.");

		String decodeContent2 = DncodeUtil.decode2(imgPath2);
