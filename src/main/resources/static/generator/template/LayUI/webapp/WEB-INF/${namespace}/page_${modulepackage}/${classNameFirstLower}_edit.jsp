	...
	<form method="post" action="" id="editFrm" class="layui-form layui-card layui-form-pane">
		<#list table.columns as column>
			<#if column.pk>
				...
				<div class="layui-card-header">数据${r"${not empty data."}${column.columnNameLower}${r"?'修改':'新增'}"}</div>
			<#else>
			</#if>
		</#list>
		<div class="layui-card-body layui-row layui-col-space15">
			<div class="layui-col-md12 layui-col-space15">
				...
				<div class="layui-form-item" style="text-align: center">
					...
					<button type="button" class="layui-btn layui-btn-normal" lay-text="返回" onclick="javascript: location.href='${r"${basePath}"}${modulepackage}/${classNameLower}/get_list'">
				...
				success: function (result) {
					if (result.code == 200) {
						layer.confirm('数据保存成功', {
							...
							location.href = '${r"${basePath}"}${modulepackage}/${classNameLower}/get_list';
						}, function(){});
					} else {
