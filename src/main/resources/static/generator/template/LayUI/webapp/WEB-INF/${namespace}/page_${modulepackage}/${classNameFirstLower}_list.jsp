...
<div class="layui-fluid">
    ...
    <div class="tool_top">
        <div class="layui-inline">
            <a href="${r"${basePath}"}${modulepackage}/${classNameLower}/jump_edit">
                <button type="button" class="layui-btn layui-btn-normal" lay-text="新增数据">
							...
							<c:when test="${r"${data_list != null && data_list.size() > 0 }"}">
								<c:forEach var="item" items="${r"${data_list}"}" varStatus="i">
									...
									<#list table.columns as column>
										<#if column.pk>
										<td align="center">
											<a class="layui-btn layui-btn-xs" href="${r"${basePath}"}${modulepackage}/${classNameLower}/jump_edit?${column.columnNameLower}=${r"${item."}${column.columnNameLower}${r"}"}" lay-text="编辑" class="e_tb_btn edit">编辑</a>
											&nbsp;&nbsp;
