...
(function () {
    ...
    var b1 = textIconOverlayBasePath + "images/polymerization/m";
    var a = "png";
    ...
    e.prototype._updateText = function () {
        if (this._domElement) {
            ...
            var className = this._domElement.className;
            var new_class = "polymerizationClass";
            if (-1 == className.indexOf(new_class)) {
                this._domElement.className += new_class;
            }
