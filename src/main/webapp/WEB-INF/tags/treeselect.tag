...
<link  rel="stylesheet" href="${baseStatic}js/jBox/Skins2/Metro/jbox.css" />
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		// 正常打开	
		$.jBox.open("iframe:${ajaxPath}tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}", "选择${title}", 300, 420, {
