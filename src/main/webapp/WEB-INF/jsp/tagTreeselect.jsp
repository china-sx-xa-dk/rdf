...
<head>
	...
	<link rel="stylesheet" href="${baseStatic}js/jquery-ztree/3.5.12/css/zTreeStyle/zTreeStyle.css" media="all">
	...
	<script type="text/javascript" src="${baseStatic}js/jquery-ztree/3.5.12/js/jquery.ztree.all-3.5.min.js" ></script>
...
<body>
	...
	<div id="search1" class="form-search div_show" style="padding:10px 0 0 13px; display: block;">
