...
<style>
.tipBox{padding-bottom:50px;border:#ddd 1px solid;background-color:#f5f5f5; background-image:url("${baseStatic}images/seller/500.png");background-position:900px center;background-repeat:no-repeat;}
